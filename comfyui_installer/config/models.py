...
MODEL_FAMILIES: list[ModelFamily] = [
    ...
    ModelFamily(2, "FLUX-Fill-Dev", "FLUX", [
        ModelOption("Q4_K_S (GGUF, <12GB VRAM)",        "flux1-fill-dev-Q4_K_S.gguf",     "gguf_flux", f"{HF}/flux1-fill-dev-Q4_K_S.gguf"),
        ModelOption("Q5_K_S (GGUF, 12-16GB VRAM)",      "flux1-fill-dev-Q5_K_S.gguf",     "gguf_flux", f"{HF}/flux1-fill-dev-Q5_K_S.gguf"),
        ModelOption("Q6     (GGUF, ~16GB VRAM)",        "flux1-fill-dev-Q5_K_S.gguf",     "gguf_flux", f"{HF}/flux1-fill-dev-Q5_K_S.gguf"),
        ModelOption("Q8_0   (GGUF, >16GB VRAM)",        "flux1-fill-dev-Q8_0.gguf",       "gguf_flux", f"{HF}/flux1-fill-dev-Q8_0.gguf"),
        ModelOption("FP8    (Safetensor, >24GB VRAM)",  "flux1-fill-dev_fp8.safetensors", "diffusion_model", f"{HF}/flux1-fill-dev_fp8.safetensors"),
    ]),
